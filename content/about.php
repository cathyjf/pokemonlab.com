...
<p>
Rather than a simple count of wins and losses, Shoddy Battle kept track of player skill using the <a href="http://www.glicko.net/glicko.html">Glicko2 rating system</a>. Rather than conceptualising a player's skill as a particular number, each player was assigned a probability distribution; a player's "played skill" realised in any particular game was understood as a random variable distributed according to a <a href="https://en.wikipedia.org/wiki/Normal_distribution">normal distribution</a> characterised by two parameters: &mu; (mean) and &sigma; (standard deviation).
</p>
