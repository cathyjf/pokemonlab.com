...
<?php startblock('title-postfix') ?> - Privacy policy<?php endblock() ?>
...
<p>
The information in this section applies to the <code>pokemonlab.com</code> website, which is also accessible under the domains <code>poke-lab.com</code> and <code>shoddybattle.com</code>.
</p>

<h3>Web server logs</h3>

<p>Like most web servers, the <code>pokemonlab.com</code> web servers may log basic information about traffic on this website, including visitor IP addresses and pages loaded. We use these logs only for monitoring and maintaining the website, including identifying areas for improvement and fixing any problems that may arise.</p>

<h3>Google Analytics</h3>

<p>
The <code>pokemonlab.com</code> website uses <a href="http://www.google.com/analytics/">Google Analytics</a> to collect statistical information regarding how the website is used. This information is not personally identifiable.
</p>

<p>Google provides a Browser Add-on for all major browsers that allows you to opt-out of data collection by Google Analytics, should you want to do so. You can get the Add-on <a href="https://tools.google.com/dlpage/gaoptout">here</a>. Alternatively, you can prevent <code>pokemonlab.com</code> from sending information to Google Analytics by disabling JavaScript in your browser for <code>pokemonlab.com</code> (Google Analytics requires JavaScript to work).</p>

<h3>Google AdSense</h3>

<p>
The <code>pokemonlab.com</code> website uses <a href="https://www.google.com/adsense/">Google AdSense</a> to display ads on some pages. Google AdSense may collect some information about visitors to this website. You can review Google's privacy policy regarding advertising <a href="http://www.google.com/policies/privacy/ads/">here</a>. That page also provides information on how to manage what information is collected and how to opt out of collection.</a>

<h2>Pok&eacute;mon Lab and Shoddy Battle</h2>

<p>The Pok&eacute;mon Lab and Shoddy Battle programs (the "software") generally do not send any information back to the developers of the software. The only exception is that some features of the software may download files from this website. For example, the software may download images of Pok&eacute;mon from this website in order to display those images in battles. When the software downloads files from this website, those downloads may be logged by our web servers, as described above. The privacy policy with respect to those logs is described above.</p>
